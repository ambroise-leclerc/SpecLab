...
- **C++23 Compatible Compiler**:
  ...
  - macOS: Apple Silicon with upstream LLVM/Clang 21.1.8 and libc++. AppleClang is not supported. Install with `brew install llvm@21 ninja`, then configure with the Ninja generator (required for `import std`): `cmake -B build -G Ninja --toolchain cmake/toolchains/macos-arm64-llvm.cmake`.
